(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["vendors-node_modules_cornerstonejs_adapters_dist_esm_index_js"],{
...
class Angle extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const point1 = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[0]);
    const point2 = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[1]);
    const point3 = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[1]);
    const point4 = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[2]);
...
class ArrowAnnotate extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const pointImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_4__.toScoord)(scoordProps, point);
    const pointImage2 = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_4__.toScoord)(scoordProps, point2);
    const TID300RepresentationArguments = {
...
class BaseAdapter3D {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const pointsImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoords)(scoordProps, tool.data.handles.points);
    const tidArguments = {
      points: pointsImage,
      trackingIdentifierTextValue: this.trackingIdentifierTextValue,
      findingSites: findingSites || [],
...
/* harmony import */ var _helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/toScoordType.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toScoordType.js");
/* harmony import */ var _helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/scoordToWorld.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/scoordToWorld.js");
...
const LONG_AXIS = "Long Axis";
const SHORT_AXIS = "Short Axis";
class Bidirectional extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_5__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      state,
      scoordArgs,
    ...
    const worldCoords = [];
    worldCoords.push(...(0,_helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_4__.scoordToWorld)(scoordArgs, longAxisScoordGroup));
    worldCoords.push(...(0,_helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_4__.scoordToWorld)(scoordArgs, shortAxisScoordGroup));
    state.annotation.data = {
      ...state.annotation.data,
      handles: {
        ...state.annotation.data.handles,
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const longAxisStartImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, shortAxisPoints[0]);
    const longAxisEndImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, shortAxisPoints[1]);
    const shortAxisStartImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, longAxisPoints[0]);
    const shortAxisEndImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, longAxisPoints[1]);
    const {
      length,
      width,
      unit
...
/* harmony import */ var _helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/toScoordType.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toScoordType.js");
/* harmony import */ var _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @cornerstonejs/core */ "../../../node_modules/@cornerstonejs/core/dist/esm/index.js");
/* harmony import */ var _metricHandler_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./metricHandler.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/metricHandler.js");
...
class CircleROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    ...
    const allNUMGroups = (0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_5__.extractAllNUMGroups)(MeasurementGroup, referencedSOPInstanceUID);
    ...
    if (referencedImageId) {
      state.annotation.data.cachedStats = {
        [`imageId:${referencedImageId}`]: {
          ...
          radius: 0,
          perimeter: 0,
          ...(0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_5__.restoreAdditionalMetrics)(measurementNUMGroups)
        }
      };
    }
    return state;
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const center = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[0]);
    const end = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, handles.points[1]);
    const {
      area,
      radius,
      max,
...
class CobbAngle extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const points = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoords)(scoordProps, handles.points);
...
class EllipticalROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const convertedPoints = points.map(point => (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoord)(scoordProps, point));
    return {
      area,
      areaUnit,
      max,
...
class LabelData {
  ...
  createQualitativeLabelPosition(annotation) {
    ...
    const {
      ...
      y,
      z
    } = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_2__.toScoord)({
      is3DMeasurement,
      referencedImageId
...
/* harmony import */ var _helpers_copyStudyTags_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/copyStudyTags.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/copyStudyTags.js");
/* harmony import */ var _helpers_copySeriesTags_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/copySeriesTags.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/copySeriesTags.js");
/* harmony import */ var _helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../helpers/scoordToWorld.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/scoordToWorld.js");
/* harmony import */ var _helpers_toPoint3_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../helpers/toPoint3.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toPoint3.js");
/* harmony import */ var _CodingScheme_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./CodingScheme.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/CodingScheme.js");
/* harmony import */ var _constants_index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");
/* harmony import */ var _LabelData_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./LabelData.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/LabelData.js");
...
const {
  MetadataModules
} = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.Enums;
const {
  TID1500,
  addAccessors
} = dcmjs__WEBPACK_IMPORTED_MODULE_0__.utilities;
...
const COMMENT = {
  CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.COMMENT_CODE.schemeDesignator,
  CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.COMMENT_CODE.value
};
const COMMENT_POSITION = {
  CodingSchemeDesignator: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.TEXT_ANNOTATION_POSITION.schemeDesignator,
  CodeValue: _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.TEXT_ANNOTATION_POSITION.value
};
const FINDING_SITE = {
  CodingSchemeDesignator: 'SCT',
  CodeValue: '363698007'
...
class MeasurementReport {
  static getTID300ContentItem(tool, ReferencedSOPSequence, toolClass, is3DMeasurement) {
    ...
    const labelMeasurement = new _LabelData_js__WEBPACK_IMPORTED_MODULE_11__["default"](tid300Measurement, tool);
  ...
  static getCornerstoneLabelFromDefaultState(defaultState) {
    ...
    const cornersoneFreeTextCodingValue = _CodingScheme_js__WEBPACK_IMPORTED_MODULE_9__["default"].codeValues.CORNERSTONEFREETEXT;
  ...
  static generateDatasetMeta() {
    return _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.metaSRAnnotation;
  }
  ...
  static processSCOORD3DGroup(_ref2) {
    ...
    _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__.utilities.updatePlaneRestriction((0,_helpers_toPoint3_js__WEBPACK_IMPORTED_MODULE_8__.toPoint3)(SCOORD3DGroup.GraphicData), toolData.state.annotation.metadata);
    return toolData;
  }
  ...
  static processSpatialCoordinatesGroup(_ref4) {
    ...
    if (commentPositionGroup) {
      ...
      const textBoxCoords = (0,_helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_7__.scoordToWorld)({
  ...
  static getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, toolType) {
    ...
    const worldCoords = (0,_helpers_scoordToWorld_js__WEBPACK_IMPORTED_MODULE_7__.scoordToWorld)(scoordArgs, scoord);
    return {
      ...spatialGroup,
      is3DMeasurement,
      scoordArgs,
  ...
  static generateReferencedSOPSequence(_ref5) {
    ...
    const effectiveImageId = imageId === _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.NO_IMAGE_ID ? this.getImageIdFromVolume({
      toolData,
      toolTypes
    }) : imageId;
  ...
  static generateReport(toolState, metadataProvider, options) {
    ...
    Object.keys(toolState).forEach(imageId => {
      const toolData = toolState[imageId];
      const toolTypes = Object.keys(toolData);
      const is3DMeasurement = imageId === _constants_index_js__WEBPACK_IMPORTED_MODULE_10__.NO_IMAGE_ID;
...
_MeasurementReport.generateDerivationSourceDataset = instance => {
  const studyTags = (0,_helpers_copyStudyTags_js__WEBPACK_IMPORTED_MODULE_5__.copyStudyTags)(instance);
  const seriesTags = (0,_helpers_copySeriesTags_js__WEBPACK_IMPORTED_MODULE_6__.copySeriesTags)(instance);
  return {
    ...studyTags,
    ...seriesTags
  };
...
/* harmony import */ var _metricHandler_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./metricHandler.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/metricHandler.js");
...
class PlanarFreehandROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    ...
    const referencedSOPInstanceUID = state.sopInstanceUid;
    const allNUMGroups = (0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_6__.extractAllNUMGroups)(MeasurementGroup, referencedSOPInstanceUID);
    const measurementNUMGroups = allNUMGroups[referencedSOPInstanceUID] || {};
    state.annotation.data = {
      ...state.annotation.data,
      contour: {
    ...
    if (referencedImageId) {
      state.annotation.data.cachedStats = {
        [`imageId:${referencedImageId}`]: {
          ...
          ...(0,_metricHandler_js__WEBPACK_IMPORTED_MODULE_6__.restoreAdditionalMetrics)(measurementNUMGroups)
        }
      };
    }
    return state;
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const points = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_4__.toScoords)(scoordProps, polyline);
    if (!isOpenContour) {
...
class Probe extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const pointsImage = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_3__.toScoords)(scoordProps, points);
    return {
      points: pointsImage,
      trackingIdentifierTextValue: this.trackingIdentifierTextValue,
      findingSites: findingSites || [],
...
/* harmony export */   generateRTSSFromContour: () => (/* binding */ generateRTSSFromContour),
/* harmony export */   generateRTSSFromLabelmap: () => (/* binding */ generateRTSSFromLabelmap),
/* harmony export */   generateRTSSFromRepresentation: () => (/* binding */ generateRTSSFromRepresentation),
...
/* harmony import */ var _utilities_getReferencedFrameOfReferenceSequence_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/getReferencedFrameOfReferenceSequence.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/RTStruct/utilities/getReferencedFrameOfReferenceSequence.js");
/* harmony import */ var _utilities_getReferencedSeriesSequence_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/getReferencedSeriesSequence.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/RTStruct/utilities/getReferencedSeriesSequence.js");
/* harmony import */ var _utilities_getRTROIObservationsSequence_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilities/getRTROIObservationsSequence.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/RTStruct/utilities/getRTROIObservationsSequence.js");
/* harmony import */ var _utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utilities/getStructureSetModule.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/RTStruct/utilities/getStructureSetModule.js");
/* harmony import */ var _utilities_referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../utilities/referencedMetadataProvider.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/referencedMetadataProvider.js");
/* harmony import */ var _utilities_createInstance_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../utilities/createInstance.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/createInstance.js");
...
} = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_1__.utilities.contours;
const {
  MetadataModules
...
async function generateRTSSFromLabelmap(segmentations, options) {
  const {
    metadataProvider = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData
  } = options;
  const roiContours = [];
  ...
  roiContours.forEach((contour, index) => {
    ...
    dataset.StructureSetROISequence.push((0,_utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_5__["default"])(contour, segment));
    dataset.RTROIObservationsSequence.push((0,_utilities_getRTROIObservationsSequence_js__WEBPACK_IMPORTED_MODULE_4__["default"])(segment, index, options));
    dataset.ROIContourSequence.push(roiContour);
    dataset.ReferencedSeriesSequence = (0,_utilities_getReferencedSeriesSequence_js__WEBPACK_IMPORTED_MODULE_3__["default"])(dataset.ReferencedSeriesSequence, contour.metadata, options);
    dataset.ReferencedFrameOfReferenceSequence = (0,_utilities_getReferencedFrameOfReferenceSequence_js__WEBPACK_IMPORTED_MODULE_2__["default"])(dataset.ReferencedFrameOfReferenceSequence, contour.metadata);
  });
...
function generateRTSSFromAnnotations(segmentations, annotations, options) {
  ...
  annotations.forEach((annotation, index) => {
    ...
    if (!segmentAnnotation) {
      ...
      const structureSetModule = (0,_utilities_getStructureSetModule_js__WEBPACK_IMPORTED_MODULE_5__["default"])(annotation, segment);
    ...
    const roiContourSequence = AnnotationToPointData.convert(annotation, segmentAnnotation.segment, _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData);
    ...
    dataset.ReferencedSeriesSequence = (0,_utilities_getReferencedSeriesSequence_js__WEBPACK_IMPORTED_MODULE_3__["default"])(dataset.ReferencedSeriesSequence, annotation.metadata, options);
    dataset.ReferencedFrameOfReferenceSequence = (0,_utilities_getReferencedFrameOfReferenceSequence_js__WEBPACK_IMPORTED_MODULE_2__["default"])(dataset.ReferencedFrameOfReferenceSequence, annotation.metadata);
  });
  if (dataset.ReferencedFrameOfReferenceSequence?.length === 1) {
    dataset.FrameOfReferenceUID = dataset.ReferencedFrameOfReferenceSequence[0].FrameOfReferenceUID;
  }
...
function _initializeDataset(segmentation, imgMetadata, options) {
  ...
  return (0,_utilities_createInstance_js__WEBPACK_IMPORTED_MODULE_7__.createInstance)(MetadataModules.RTSS_INSTANCE_DATA, studyExemplarImageId, {
    StructureSetLabel: segmentation.label,
    StructureSetName: segmentation.label,
    SeriesDescription: segmentation.label,
    _meta: _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.RTSS_CONTOUR, studyExemplarImageId)
  }, options);
}
function generateRTSSFromContour(segmentations, options) {
  ...
  for (const annotationSet of annotationUIDsMap.values()) {
    for (const annotationUID of annotationSet.values()) {
      const annotation$1 = _cornerstonejs_tools__WEBPACK_IMPORTED_MODULE_1__.annotation.state.getAnnotation(annotationUID);
      if (!annotation$1) {
...
/* harmony export */   generateRTSSFromContour: () => (/* reexport safe */ _RTSS_js__WEBPACK_IMPORTED_MODULE_1__.generateRTSSFromContour),
/* harmony export */   generateRTSSFromLabelmap: () => (/* reexport safe */ _RTSS_js__WEBPACK_IMPORTED_MODULE_1__.generateRTSSFromLabelmap),
/* harmony export */   generateRTSSFromRepresentation: () => (/* reexport safe */ _RTSS_js__WEBPACK_IMPORTED_MODULE_1__.generateRTSSFromRepresentation),
...
function getReferencedSeriesSequence(referencedSeriesSequence, metadata, options) {
  const metadataProvider = options?.metadataProvider || _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData;
  const {
...
/* harmony export */ });
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/toScoordType.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/toScoordType.js");
/* harmony import */ var _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @cornerstonejs/core */ "../../../node_modules/@cornerstonejs/core/dist/esm/index.js");
/* harmony import */ var _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MeasurementReport.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/MeasurementReport.js");
/* harmony import */ var _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BaseAdapter3D.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/BaseAdapter3D.js");
/* harmony import */ var _metricHandler_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./metricHandler.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/metricHandler.js");
...
class RectangleROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  static isValidMeasurement(measurement) {
    const graphicItem = this.getGraphicItem(measurement);
  ...
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata) {
    const {
      ...
      referencedImageId,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_3__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, this.toolType);
  ...
  static getTID300RepresentationArguments(tool) {
    ...
    const corners = (0,_helpers_toScoordType_js__WEBPACK_IMPORTED_MODULE_1__.toScoords)(scoordProps, data.handles.points);
    const {
      area,
      perimeter,
      max,
...
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @cornerstonejs/core */ "../../../node_modules/@cornerstonejs/core/dist/esm/index.js");
/* harmony import */ var _Cornerstone_Segmentation_4X_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Cornerstone/Segmentation_4X.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone/Segmentation_4X.js");
...
function generateSegmentation(images, labelmaps, metadata) {
  ...
  const segmentationResult = (0,_Cornerstone_Segmentation_4X_js__WEBPACK_IMPORTED_MODULE_2__.fillSegmentation)(segmentation, labelmaps, options);
...
/* harmony export */   ImplementationClassRtssContours: () => (/* binding */ ImplementationClassRtssContours),
/* harmony export */   ImplementationClassUidSRAnnotation: () => (/* binding */ ImplementationClassUidSRAnnotation),
/* harmony export */   NO_IMAGE_ID: () => (/* binding */ NO_IMAGE_ID),
/* harmony export */   TEXT_ANNOTATION_POSITION: () => (/* binding */ TEXT_ANNOTATION_POSITION),
/* harmony export */   fileMetaInformationVersionArray1: () => (/* binding */ fileMetaInformationVersionArray1),
/* harmony export */   fileMetaInformationVersionArray2: () => (/* binding */ fileMetaInformationVersionArray2),
/* harmony export */   metaRTSSContour: () => (/* binding */ metaRTSSContour),
/* harmony export */   metaSRAnnotation: () => (/* binding */ metaSRAnnotation)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   extractAllNUMGroups: () => (/* binding */ extractAllNUMGroups),
/* harmony export */   restoreAdditionalMetrics: () => (/* binding */ restoreAdditionalMetrics)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NO_IMAGE_ID: () => (/* reexport safe */ _Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_2__.NO_IMAGE_ID),
...
/* harmony import */ var _Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Cornerstone3D/constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");
/* harmony import */ var _VTKjs_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./VTKjs/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/VTKjs/index.js");
/* harmony import */ var _enums_Events_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./enums/Events.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/enums/Events.js");
...
const adaptersSEG = {
  ...
  VTKjs: _VTKjs_index_js__WEBPACK_IMPORTED_MODULE_3__.VTKjsSEG
};
const adaptersPMAP = {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Enums: () => (/* reexport module object */ _adapters_enums_index_js__WEBPACK_IMPORTED_MODULE_2__),
/* harmony export */   NO_IMAGE_ID: () => (/* reexport safe */ _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_4__.NO_IMAGE_ID),
...
/* harmony export */   helpers: () => (/* reexport module object */ _adapters_helpers_index_js__WEBPACK_IMPORTED_MODULE_3__),
/* harmony export */   utilities: () => (/* reexport module object */ _utilities_index_js__WEBPACK_IMPORTED_MODULE_1__)
/* harmony export */ });
...
/* harmony import */ var _utilities_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/index.js");
/* harmony import */ var _adapters_enums_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./adapters/enums/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/enums/index.js");
/* harmony import */ var _adapters_helpers_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./adapters/helpers/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/index.js");
/* harmony import */ var _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./adapters/Cornerstone3D/constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   assignDefined: () => (/* binding */ assignDefined),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IMAGE_MODULES: () => (/* reexport safe */ _referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_0__.IMAGE_MODULES),
/* harmony export */   SERIES_MODULES: () => (/* reexport safe */ _referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_0__.SERIES_MODULES),
/* harmony export */   STUDY_MODULES: () => (/* reexport safe */ _referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_0__.STUDY_MODULES),
/* harmony export */   assignDefined: () => (/* reexport safe */ _createInstance_js__WEBPACK_IMPORTED_MODULE_1__.assignDefined),
/* harmony export */   createInstance: () => (/* reexport safe */ _createInstance_js__WEBPACK_IMPORTED_MODULE_1__.createInstance),
/* harmony export */   metadataProvider: () => (/* reexport safe */ _referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_0__.metadataProvider)
/* harmony export */ });
/* harmony import */ var _referencedMetadataProvider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./referencedMetadataProvider.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/referencedMetadataProvider.js");
/* harmony import */ var _createInstance_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createInstance.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/utilities/createInstance.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IMAGE_MODULES: () => (/* binding */ IMAGE_MODULES),
/* harmony export */   SERIES_MODULES: () => (/* binding */ SERIES_MODULES),
/* harmony export */   STUDY_MODULES: () => (/* binding */ STUDY_MODULES),
/* harmony export */   metadataProvider: () => (/* binding */ metadataProvider)
/* harmony export */ });
/* harmony import */ var _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @cornerstonejs/core */ "../../../node_modules/@cornerstonejs/core/dist/esm/index.js");
/* harmony import */ var dcmjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dcmjs */ "../../../node_modules/dcmjs/build/dcmjs.es.js");
/* harmony import */ var _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../adapters/Cornerstone3D/constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");
...
const metadataProvider = {
  ...
  [MetadataModules.IMAGE_SOP_INSTANCE_REFERENCE]: function (imageId) {
    const frameModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.FRAME_MODULE, imageId);
    const {
      sopClassUID,
      sopInstanceUID,
      frameNumber,
  ...
  [MetadataModules.REFERENCED_SERIES_REFERENCE]: imageId => {
    const sopModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.SOP_COMMON, imageId);
    const seriesModule = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.GENERAL_SERIES, imageId);
    return {
  ...
  [MetadataModules.PREDECESSOR_SEQUENCE]: imageId => {
    const result = {
      ..._cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.SERIES_DATA, imageId)
    };
    const generalImage = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.GENERAL_IMAGE, imageId);
    const study = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.GENERAL_STUDY, imageId);
  ...
  [MetadataModules.STUDY_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.getNormalized(imageId, STUDY_MODULES);
  },
  [MetadataModules.SERIES_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.getNormalized(imageId, SERIES_MODULES);
  },
  [MetadataModules.IMAGE_DATA]: imageId => {
    return _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.getNormalized(imageId, IMAGE_MODULES);
  },
  [MetadataModules.RTSS_INSTANCE_DATA]: imageId => {
    const newInstanceData = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.NEW_INSTANCE_DATA, imageId);
    return {
      ...newInstanceData,
      SeriesNumber: '3201',
  ...
  [MetadataModules.NEW_INSTANCE_DATA]: imageId => {
    const studyData = _cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.get(MetadataModules.STUDY_DATA, imageId);
    return {
      ...studyData,
      SeriesNumber: '50000',
      InstanceNumber: '1',
  ...
  [MetadataModules.RTSS_CONTOUR]: () => _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_2__.metaRTSSContour,
  [MetadataModules.SR_ANNOTATION]: () => _adapters_Cornerstone3D_constants_index_js__WEBPACK_IMPORTED_MODULE_2__.metaSRAnnotation
};
_cornerstonejs_core__WEBPACK_IMPORTED_MODULE_0__.metaData.addProvider(metadataProvider.get, 9023);
...
//# sourceMappingURL=vendors-node_modules_cornerstonejs_adapters_dist_esm_index_js.js.map