...
export function Topbar() {
  ...
  function handleLogout() {
    document.cookie = 'sqk_session=; Max-Age=0; path=/';
    ...
    <header className="sticky top-0 z-20 flex h-[76px] items-center justify-between border-b border-panelBorder bg-shellTop px-5 lg:px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden text-right md:block">
          <div className="text-sm font-medium text-white">SQK dcm4chee Migration Console</div>
          <div className="text-xs text-mutedText">Archive, study, monitoring, and configuration workflows</div>
        </div>
